...
import { getCourseInfo, getCourseOrgInfo } from "../../../../../services/CardsServices";
...
const CourseOrgEdit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.put(`http://localhost:3001/cards-org-page/${courseOrgId}`, courseData); // آدرس API خود را وارد کنید

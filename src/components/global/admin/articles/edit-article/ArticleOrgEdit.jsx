...
const  ArticleOrgEdit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.put(
        `http://localhost:3001/article-org-page/${ ArticleOrgId}`,
        articleData
  ...
  return (
    <div className="form-container">
      <h1 className="form-title">اضافه کردن مقاله به صفحه اصلی</h1>
